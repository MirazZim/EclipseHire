    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50 px-4">
      <div className="bg-white shadow-xl rounded-3xl overflow-hidden flex flex-col items-center p-8 w-full max-w-md border border-gray-200">
        ...
        <p className="text-gray-500 text-sm mt-2">
          Already Have an account? Just jump right back Then
        </p>
        ...
        <form onSubmit={handleSignIn} className="w-full mt-6 space-y-4">
          <div className="">
            ...
            <input
              ...
              className="mt-2 w-full px-4 py-3 bg-gray-100 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
              required
            />
          </div>
          <div className="">
          ...
          <button className="w-full py-3 text-white bg-blue-500 hover:bg-blue-600 rounded-xl font-semibold transition duration-200 shadow-md">
            Sign In
          </button>
        </form>
