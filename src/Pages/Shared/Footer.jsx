            ...
            <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:py-16 lg:px-8">
                <div className="xl:grid xl:grid-cols-4 xl:gap-8">
                    <div className="space-y-8 xl:col-span-1">
                        ...
                        >
                            <img src={Logo} alt="EclipseHire Logo" className="h-10 w-10" />
                            <span className="text-2xl font-bold text-white">EclipseHire</span>
                        </motion.div>
                        <p className="text-gray-400 text-sm">
                            Connecting talented professionals with their dream careers since 2023. Your next opportunity awaits.
                        </p>
                    ...
                    <div className="mt-12 grid grid-cols-3 gap-8 xl:mt-0 xl:col-span-3">
                        <div>
                            ...
                            <ul className="mt-4 space-y-4">
                                <li><a href="#" className="text-base text-gray-400 hover:text-white transition-colors">Job Search</a></li>
                                <li><a href="#" className="text-base text-gray-400 hover:text-white transition-colors">Career Advice</a></li>
                                <li><a href="#" className="text-base text-gray-400 hover:text-white transition-colors">Resume Builder</a></li>
                                <li><a href="#" className="text-base text-gray-400 hover:text-white transition-colors">Salary Guide</a></li>
                            </ul>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <ul className="mt-4 space-y-4">
                                ...
                                <li><a href="#" className="text-base text-gray-400 hover:text-white transition-colors">Partners</a></li>
                ...
                <div className="mt-12 border-t border-gray-700 pt-8">
                    <p className="text-base text-gray-400 text-center">
                        © 2024 EclipseHire. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
